...
| `portals-kr.example.yml` | Korean onboarding | Wanted / Saramin / JobKorea / Remember boards + backend/fullstack `title_filter` + `blocked_companies` example (`ExampleCorp`). Copy to `portals.yml`. |
