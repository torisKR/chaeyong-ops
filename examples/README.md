...
2. Use `cv.example.md` (Korean fullstack/backend skeleton) or `examples/cv-example.md` as a structural guide when writing your `cv.md`. Do not copy placeholder metrics as if they were yours.
